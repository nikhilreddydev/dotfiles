...
# old path variable with windows folders, this is added by windows. And it clutters tab completion.
...
# so, get the default path and add only what paths are necessary
